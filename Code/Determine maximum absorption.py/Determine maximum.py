...
with open(r'C:\Users\ruben\Documents\GitHub\Non-Relativistic-saturation-spectroscopy\Code\F0000CH1.CSV', 'r') as file:
    next(file)
    for line in file:
        line_splitted = line.split(',')
        x.append(float(line_splitted[2]))
        y.append(float(line_splitted[3]))
